...
set extName=display_measure
set dllName=display_measure
set gmlDir14=%solutionDir%display_measure.gmx
set gmlDir22=%solutionDir%display_measure_yy
set gmlDir23=%solutionDir%display_measure_23
